...
//    logger("grails", OFF, ['STDOUT'], false)
    ...
    logger("grails.plugin.springsecurity.web.filter.DebugFilter", ALL, ['STDOUT'], false)
    logger("org.springframework.security", ALL, ['STDOUT'], false)
//
    logger("webpoint", ALL, ["STDOUT"], false)
