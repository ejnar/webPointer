...
if "x%GRAILS_AGENT_CACHE_DIR%" == "x" set GRAILS_AGENT_CACHE_DIR=%SHORTHOME%/.grails/2.4.0.M2/
...
set STARTER_CLASSPATH=wrapper/grails-wrapper-runtime-2.4.0.M2.jar;wrapper;.
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version=2.4.0.M2
